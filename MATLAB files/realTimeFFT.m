...
figureHandle = figure('Name', ['Espectro FFT en Tiempo Real (N=' num2str(FFT_SIZE) ')'], 'NumberTitle', 'off');
hold on;
...
title(['Espectro FFT (N=' num2str(FFT_SIZE) ', Fs=' num2str(PCM_SAMPLING_FREQ/1000) 'kHz)']);
