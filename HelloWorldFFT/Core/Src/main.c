...
float32_t fft_input[FFT_Length] = {0};
float32_t fft_keeper[FFT_Length] = {0};
float32_t fft_output[FFT_Length] = {0};
SIGNAL signal = SIN;
float sampling_freq = FFT_Length*SIGNAL_FREQ;
/* USER CODE END PV */
